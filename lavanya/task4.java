...
public void Examination() {
	...
	Ques1.add("JDK");
	Ques1.add("4");
	queries.put("____ is used to compile,debug and execute the java program?",Ques1);
	ArrayList<String> Ques2=new ArrayList<String>();
	Ques2.add("identifiers and keywords");
	Ques2.add("keyword");
	Ques2.add("identifier");
	Ques2.add("none of the mensioned");
	Ques2.add("2");
	queries.put("Which of these can not be used for a variable name in java?",Ques2);
	ArrayList<String> Ques3=new ArrayList<String>();
	Ques3.add("MAVEN_Path");
	Ques3.add("javaPATH");
	Ques3.add("JAVA");
	Ques3.add("JAVA_HOME");
	Ques3.add("4");
	queries.put("Which environment variable is used to set the java path?",Ques3);
	...
	Ques5.add("if()");
	Ques5.add("4");
	queries.put("Which of these are selection statements in java?",Ques5);
	int sno=0;
